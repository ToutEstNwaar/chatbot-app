...
export const BrainCircuitIcon = (props: React.SVGProps<SVGSVGElement>) => (
    <svg {...props} xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
        <path d="M12 2a4.5 4.5 0 0 0-4.5 4.5v.5a4.5 4.5 0 0 0-4.5 4.5v2a4.5 4.5 0 0 0 4.5 4.5h.5a4.5 4.5 0 0 0 4.5 4.5v-2.25a4.5 4.5 0 0 0-4.5-4.5h-.5a4.5 4.5 0 0 0-4.5-4.5v-2a4.5 4.5 0 0 0 4.5-4.5Z"/>
        <path d="M12 2a4.5 4.5 0 0 1 4.5 4.5v.5a4.5 4.5 0 0 1 4.5 4.5v2a4.5 4.5 0 0 1-4.5 4.5h-.5a4.5 4.5 0 0 1-4.5 4.5v-2.25a4.5 4.5 0 0 1 4.5-4.5h.5a4.5 4.5 0 0 1 4.5-4.5v-2a4.5 4.5 0 0 1-4.5-4.5Z"/>
        <path d="M12 2v20"/>
    </svg>
);
